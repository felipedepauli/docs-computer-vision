...
h, w = image_BGR.shape[:2] # get height and width of the image
# The third position stands for the channels of the image

print(image_BGR.shape)
print('Height: {}, Width: {}'.format(image_BGR.shape[0], image_BGR.shape[1]))
...
network = cv.dnn.readNetFromDarknet('yolo-coco-data/yolov3.cfg',
...
# With OpenCV function 'cv.dnn.blobFromImage' we get 4-dimensional
...
#  - width
#  - height
# E.G.: blob = cv.dnn.blobFromImage(image, scalefactor=1.0, size, mean, swapRB=True)
# """
